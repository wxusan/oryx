    ...
    >
      ...
      <div className="relative z-10 flex h-full flex-col lg:flex-row" style={{ minHeight: "90vh" }}>
          ...
          <div className="flex items-start justify-between gap-4 lg:block">
            ...
            >
              <Image
                ...
                style={{ filter: "brightness(1.0) contrast(1.02) saturate(0)" }}
              />
            </motion.div>
          </div>
        ...
        >
          ...
          {/* Left fade */}
          <div className="absolute inset-0" style={{ background: "linear-gradient(90deg,#020202 0%,rgba(2,2,2,0.2) 20%,transparent 42%)" }} />
